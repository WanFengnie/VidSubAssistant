...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument(
        "--source-lang",
        default="auto",
        choices=["auto", "en", "zh-CN", "zh-TW", "ja", "ko", "fr", "de", "es", "ru", "vi", "th"],
        help="源语言，默认 auto 由 Whisper 自动检测；能确定时建议手动指定，识别更稳",
    )
    ...
    p.add_argument("--ollama-model", default="", help="Ollama 模型名")
    p.add_argument("--ollama-url", default="", help="Ollama 地址")
